...
return array(
	...
	'content'    => '<div class="site-header">
                    ...
                    <nav id="site-navigation" class="main-navigation"> 
                        ...
                        <ul class="wp-block-social-links has-icon-color is-style-logos-only"><!-- wp:social-link {"url":"https://facebook.com/erikdmitchell","service":"facebook"} /-->
                        
                        <!-- wp:social-link {"url":"https://twitter.com/erikdmitchell","service":"twitter"} /-->
                        
                        <!-- wp:social-link {"url":"https://instagram.com/erikdmitchell","service":"instagram"} /--></ul>
                        <!-- /wp:social-links --></div>
                        <!-- /wp:group --></div>
                        <!-- /wp:column --></div>
                        <!-- /wp:columns -->     
